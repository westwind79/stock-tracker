"""
Static JSON Generator for Workday Insider Trading Tracker
Scrapes SEC EDGAR and generates JSON files for static hosting
"""
...
def parse_sec_filings_list(html_content):
    ...
    for row in rows[:20]:  # Last 20 filings
...
def main():
    ...
    print("2. Update frontend to read from static JSON files")
    print("3. Run this script weekly/daily to refresh data")
